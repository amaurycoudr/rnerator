...
running command...
$ rnerator (--version)
rnerator/0.6.4 darwin-arm64 node-v18.7.0
...
_See code: [dist/commands/generate/index.ts](https://github.com/amaurycoudr/rnerator/blob/v0.6.4/dist/commands/generate/index.ts)_
...
_See code: [dist/commands/init/index.ts](https://github.com/amaurycoudr/rnerator/blob/v0.6.4/dist/commands/init/index.ts)_
